...
export default {
  ...
  staticRoot: process.env.STATIC_PATH || join(esDirname(import.meta), '../', './static'),
  projectRoot: join(esDirname(import.meta), '../'),
  logsRoot: process.env.LOGS_PATH || join(esDirname(import.meta), '../', './logs'),
  uploadsRoot: process.env.UPLOADS_PATH || join(esDirname(import.meta), '../', './data'),
  defaultLocale: 'ru',
  redis: {
